				...
				<div class="row form-group">
					<div class="col-lg-12 col-md-12 form-group">
						<label>Tên dự án (*)</label> <input class="form-control"
							placeholder="Nhập tên dự án tại đây" name="ten" value=""
							type="text">
					</div>
				</div>
				<div class="row form-group">
					<div class="col-lg-12 col-md-12 form-group">
						<label>Link(*)</label> <input class="form-control" name="link"
							value="" placeholder="Nhập link dự án tại đây" type="text">
					</div>
				</div>
				<div class="row form-group">
					<div class="col-lg-12 form-group">
						<label>Hình ảnh</label> <input name="hinhanh" value="" type="file">
					</div>
				</div>
				<div class="row form-group">
					<div class="col-lg-12 form-group">
